...
const SITE_URL = process.env.VITE_SITE_URL ?? "https://qrclaim.local/";
...
//   standalone-send     one self-contained qrclaim-sender.html
//   standalone-receive  one self-contained qrclaim-receiver.html
//
  ...
  if (standalone) {
    return {
      ...
      plugins: [
        ...
        emitAs(outDir, `${page}/index.html`, `qrclaim-${page === "send" ? "sender" : "receiver"}.html`),
      ],
