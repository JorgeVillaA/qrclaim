...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — 光でファイルを転送",
    metaDescription:
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — 送信",
    eyebrow: "画面 → カメラ",
    ...
    shareTitleData: "QRClaim Optical Transfer — 受信ページ",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — 受信",
    eyebrow: "カメラ → このデバイス",
    title: "受信",
  ...
  verdicts: {
    olderSender: (version) =>
      `相手の画面は古い QRClaim 形式 (v${version}) で送信しています。送信側のデバイスを更新してください。`,
    newerSender: (version) =>
      `相手の画面は新しい QRClaim 形式 (v${version}) で送信しています。受信するには、このアプリを更新してください。`,
    unsupportedFlags:
      "このストリームは、このバージョンでは読み取れない QRClaim の機能を使用しています。受信するには、このアプリを更新してください。",
  },
  ...
  i18n: {
    ...
    switchOffer: "QRClaim は日本語でもご利用いただけます。",
    switchAction: "日本語で表示",
  },
};
