...
export const messages: Messages = {
  ...
  home: {
    title: "QR Claim — transfer files with light",
    metaDescription:
    ...
    shareSite: "Share QR Claim",
    supportTitle: "Free, open source, no ads",
    supportBodyHtml:
      'If QR Claim made your day easier.',
  ...
  send: {
    ...
    shareTitleData: "QR Claim — receiver",
  ...
  receive: {
    ...
    clearCache: "Clear QR Claim cache",
  ...
  verdicts: {
    olderSender: (version) =>
      `That screen is sending an older QR Claim format (v${version}). Update the sending device.`,
    newerSender: (version) =>
      `That screen is sending a newer QR Claim format (v${version}). Update this app to receive it.`,
    unsupportedFlags:
      "That stream uses a QR Claim feature this version cannot read. Update this app to receive it.",
  },
  ...
  i18n: {
    ...
    switchOffer: "QR Claim is available in English.",
