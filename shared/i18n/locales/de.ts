...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — Dateien mit Licht übertragen",
    metaDescription:
    ...
    shareSite: "QRClaim teilen",
    supportTitle: "Kostenlos, Open Source, ohne Werbung",
    supportBodyHtml:
      'Wenn QRClaim Ihnen den Tag leichter gemacht hat.',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — Senden",
    ...
    shareTitleData: "QRClaim Optical Transfer — Empfänger",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — Empfangen",
    ...
    clearCache: "QRClaim-Cache leeren",
  ...
  verdicts: {
    olderSender: (version) =>
      `Dieser Bildschirm sendet ein älteres QRClaim-Format (v${version}). Aktualisieren Sie das sendende Gerät.`,
    newerSender: (version) =>
      `Dieser Bildschirm sendet ein neueres QRClaim-Format (v${version}). Aktualisieren Sie diese App, um es zu empfangen.`,
    unsupportedFlags:
      "Dieser Stream nutzt eine QRClaim-Funktion, die diese Version nicht lesen kann. Aktualisieren Sie diese App, um ihn zu empfangen.",
  },
  ...
  i18n: {
    ...
    switchOffer: "QRClaim ist auf Deutsch verfügbar.",
