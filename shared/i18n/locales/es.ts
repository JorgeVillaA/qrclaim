...
export const messages: Messages = {
  ...
  home: {
    title: "QR Claim — transferir archivos con luz",
    metaDescription:
    ...
    shareSite: "Compartir QR Claim",
    supportTitle: "Gratis, de código abierto, sin anuncios",
    supportBodyHtml:
      'Si QR Claim le facilitó el día.',
  ...
  send: {
    ...
    shareTitleData: "QR Claim — receptor",
  ...
  receive: {
    ...
    clearCache: "Borrar caché de QR Claim",
  ...
  verdicts: {
    olderSender: (version) =>
      `Esa pantalla está enviando un formato QR Claim más antiguo (v${version}). Actualice el dispositivo emisor.`,
    newerSender: (version) =>
      `Esa pantalla está enviando un formato QR Claim más nuevo (v${version}). Actualice esta aplicación para recibirlo.`,
    unsupportedFlags:
      "Esa transmisión usa una función de QR Claim que esta versión no puede leer. Actualice esta aplicación para recibirla.",
  },
  ...
  i18n: {
    ...
    switchOffer: "QR Claim está disponible en español.",
