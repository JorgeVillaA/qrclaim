...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — transférer des fichiers par la lumière",
    metaDescription:
    ...
    shareSite: "Partager QRClaim",
    supportTitle: "Gratuit, open source, sans publicité",
    supportBodyHtml:
      'Si QRClaim vous a facilité la vie.',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — envoyer",
    ...
    shareTitleData: "QRClaim Optical Transfer — récepteur",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — recevoir",
    ...
    clearCache: "Vider le cache QRClaim",
  ...
  verdicts: {
    olderSender: (version) =>
      `Cet écran envoie un format QRClaim plus ancien (v${version}). Mettez à jour ` +
      `l’appareil émetteur.`,
    newerSender: (version) =>
      `Cet écran envoie un format QRClaim plus récent (v${version}). Mettez à jour ` +
      `cette application pour le recevoir.`,
    unsupportedFlags:
      "Ce flux utilise une fonctionnalité QRClaim que cette version ne sait pas lire. " +
  ...
  i18n: {
    ...
    switchOffer: "QRClaim est disponible en français.",
