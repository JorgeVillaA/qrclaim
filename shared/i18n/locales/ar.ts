...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — نقل الملفات بالضوء",
    metaDescription:
    ...
    shareSite: "مشاركة QRClaim",
    supportTitle: "مجاني ومفتوح المصدر وبلا إعلانات",
    supportBodyHtml:
      'إذا جعل QRClaim يومك أسهل.',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — الإرسال",
    ...
    shareTitleData: "QRClaim Optical Transfer — المستقبِل",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — الاستقبال",
    ...
    clearCache: "مسح ذاكرة QRClaim المؤقتة",
  ...
  verdicts: {
    olderSender: (version) =>
      `تلك الشاشة ترسل بتنسيق QRClaim أقدم (v${version}). حدِّث الجهاز المرسِل.`,
    newerSender: (version) =>
      `تلك الشاشة ترسل بتنسيق QRClaim أحدث (v${version}). حدِّث هذا التطبيق لاستقباله.`,
    unsupportedFlags:
      "يستخدم هذا البث ميزة من QRClaim لا يستطيع هذا الإصدار قراءتها. حدِّث هذا التطبيق لاستقباله.",
  },
  ...
  i18n: {
    ...
    switchOffer: "يتوفر QRClaim باللغة العربية.",
