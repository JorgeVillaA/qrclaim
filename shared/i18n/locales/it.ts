...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — trasferisci file con la luce",
    metaDescription:
    ...
    shareSite: "Condividi QRClaim",
    supportTitle: "Gratuito, open source, senza pubblicità",
    supportBodyHtml:
      'Se QRClaim ti ha semplificato la giornata.',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — invio",
    ...
    shareTitleData: "QRClaim Optical Transfer — ricevitore",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — ricezione",
    ...
    clearCache: "Svuota la cache di QRClaim",
  ...
  verdicts: {
    olderSender: (version) =>
      `Quello schermo trasmette un formato QRClaim più vecchio (v${version}). Aggiorna il dispositivo che invia.`,
    newerSender: (version) =>
      `Quello schermo trasmette un formato QRClaim più recente (v${version}). Aggiorna questa app per riceverlo.`,
    unsupportedFlags:
      "Quel flusso usa una funzionalità di QRClaim che questa versione non sa leggere. Aggiorna questa app per riceverlo.",
  },
  ...
  i18n: {
    ...
    switchOffer: "QRClaim è disponibile in italiano.",
