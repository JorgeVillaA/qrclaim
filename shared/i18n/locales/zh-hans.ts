...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — 用光传输文件",
    metaDescription:
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — 发送",
    eyebrow: "屏幕 → 摄像头",
    ...
    shareTitleData: "QRClaim Optical Transfer — 接收器",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — 接收",
    eyebrow: "摄像头 → 你的设备",
    title: "接收",
  ...
  verdicts: {
    olderSender: (version) =>
      `对方屏幕正在以较旧的 QRClaim 格式（v${version}）发送。请更新发送设备。`,
    newerSender: (version) =>
      `对方屏幕正在以较新的 QRClaim 格式（v${version}）发送。请更新本应用后再接收。`,
    unsupportedFlags: "该数据流使用了此版本无法读取的 QRClaim 功能。请更新本应用后再接收。",
  },
