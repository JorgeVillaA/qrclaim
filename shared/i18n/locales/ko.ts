...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — 빛으로 파일 전송",
    metaDescription:
    ...
    shareSite: "QRClaim 공유",
    supportTitle: "무료, 오픈 소스, 광고 없음",
    supportBodyHtml:
      'QRClaim이 도움이 되었으면 합니다.',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — 보내기",
    eyebrow: "화면 → 카메라",
    ...
    shareTitleData: "QRClaim Optical Transfer — 수신기",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — 받기",
    eyebrow: "카메라 → 내 기기",
    title: "받기",
  ...
  verdicts: {
    olderSender: (version) =>
      `상대 화면이 이전 버전의 QRClaim 형식(v${version})을 보내고 있습니다. 보내는 기기를 업데이트하세요.`,
    newerSender: (version) =>
      `상대 화면이 더 새로운 QRClaim 형식(v${version})을 보내고 있습니다. 받으려면 이 앱을 업데이트하세요.`,
    unsupportedFlags:
      "이 스트림은 이 버전에서 읽을 수 없는 QRClaim 기능을 사용합니다. 받으려면 이 앱을 업데이트하세요.",
  },
  ...
  i18n: {
    ...
    switchOffer: "QRClaim을 한국어로 볼 수 있습니다.",
