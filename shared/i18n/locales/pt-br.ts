...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — transfira arquivos com luz",
    metaDescription:
    ...
    shareSite: "Compartilhar o QRClaim",
    supportTitle: "Gratuito, código aberto, sem anúncios",
    supportBodyHtml:
      'Se o QRClaim facilitou o seu dia.',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — enviar",
    eyebrow: "Tela → câmera",
    ...
    shareTitleData: "QRClaim Optical Transfer — receptor",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — receber",
    ...
    clearCache: "Limpar cache do QRClaim",
  ...
  verdicts: {
    olderSender: (version) =>
      `Aquela tela está enviando um formato QRClaim mais antigo (v${version}). Atualize o dispositivo de envio.`,
    newerSender: (version) =>
      `Aquela tela está enviando um formato QRClaim mais novo (v${version}). Atualize este app para recebê-lo.`,
    unsupportedFlags:
      "Esse fluxo usa um recurso do QRClaim que esta versão não consegue ler. Atualize este app para recebê-lo.",
  },
  ...
  i18n: {
    ...
    switchOffer: "O QRClaim está disponível em português.",
