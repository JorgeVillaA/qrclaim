...
export const messages: Messages = {
  ...
  home: {
    title: "QRClaim Optical Transfer — रोशनी से फ़ाइलें ट्रांसफ़र करें",
    metaDescription:
    ...
    shareSite: "QRClaim शेयर करें",
    supportTitle: "मुफ़्त, ओपन सोर्स, बिना विज्ञापन",
    supportBodyHtml:
      'अगर QRClaim ने आपका काम आसान किया हो।',
  ...
  send: {
    docTitle: "QRClaim Optical Transfer — भेजें",
    ...
    shareTitleData: "QRClaim Optical Transfer — रिसीवर",
  ...
  receive: {
    docTitle: "QRClaim Optical Transfer — प्राप्त करें",
    ...
    clearCache: "QRClaim कैश साफ़ करें",
  ...
  verdicts: {
    olderSender: (version) =>
      `वह स्क्रीन पुराना QRClaim फ़ॉर्मैट (v${version}) भेज रही है। भेजने वाले डिवाइस को अपडेट करें।`,
    newerSender: (version) =>
      `वह स्क्रीन नया QRClaim फ़ॉर्मैट (v${version}) भेज रही है। इसे प्राप्त करने के लिए यह ऐप अपडेट करें।`,
    unsupportedFlags:
      "वह स्ट्रीम QRClaim की ऐसी सुविधा इस्तेमाल करती है जिसे यह वर्शन नहीं पढ़ सकता। इसे प्राप्त करने के लिए यह ऐप अपडेट करें।",
  },
  ...
  i18n: {
    ...
    switchOffer: "QRClaim हिन्दी में उपलब्ध है।",
