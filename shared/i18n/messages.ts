...
//
// FOR TRANSLATORS
//   - Keep "QRClaim" and "QRClaim Optical Transfer" untranslated; same for
...
export interface Messages {
  ...
  home: {
    ...
    shareSite: string; // "Share QRClaim"
  ...
  send: {
    docTitle: string; // "QRClaim Optical Transfer — send"
   ...
   * any QRClaim client showing one of these shows this catalog's wording.
   */
  errors: {
    fileEmpty: string;
  ...
  i18n: {
     ...
     *  Written in THIS language ("QRClaim est disponible en français"). */
    switchOffer: string;
